...
|---|---|---|---|---|---|---|---|---|---|---|
| all | 80 | 38% | 50% | 22 | 150 | 436 | 570 | 46% | 23.8% | 0.195 |

## By phase

| group | n | agree | <=25cp | median | robust mean | p90 | p95 | >=100cp | >=300cp | E-loss |
|---|---|---|---|---|---|---|---|---|---|---|
| ? | 80 | 38% | 50% | 22 | 150 | 436 | 570 | 46% | 23.8% | 0.195 |
...
| sa-014 | 570 | c1c2 | b4b5 | 42 | None |  | `R7/2r4k/5qp1/3p1r1p/1P2pP1P/P1p1P1Q1/6PK/2R5 w - - 0 43` |
| sa-064 | 540 | d4d5 | g1f1 | -78 | None |  | `1R6/8/8/7p/2rP3P/2k1p3/6P1/6K1 w - - 0 69` |
| sa-008 | 481 | b5c6 | b1d1 | 0 | None |  | `8/8/8/1k2B2R/8/1p1K3P/p5P1/1r6 b - - 1 51` |
| sa-034 | 477 | b5b8 | b3b1 | -66 | None |  | `5rk1/6p1/2r1p2p/1R6/4RN2/PQ3P2/4KP1n/q7 w - - 20 44` |
| sa-071 | 436 | e7d7 | d8c8 | -51 | None |  | `3k4/1p2r1p1/p2R1p1p/P2p1P2/1P1P2P1/2P5/3K4/8 b - - 6 47` |
| sa-015 | 416 | f8d6 | f8c5 | -95 | None |  | `5Bk1/2r5/q4ppQ/2p5/P1bnP2P/1p4P1/6BK/2R5 w - - 3 46` |
| sa-078 | 392 | e3f1 | e3d5 | -61 | None |  | `8/8/1p6/p5k1/P1P5/1P2Nn2/6Kp/8 w - - 1 56` |
| sa-022 | 364 | c2e2 | c4c5 | -84 | None |  | `r2rn1k1/1p2b1p1/3pq3/p3p1Pp/PpP1Pp2/3B1N1P/1PQ2P2/1K1R3R w - - 2 28` |
| sa-049 | 362 | e6e7 | c6a8 | 108 | None |  | `r2q4/p1p3kp/2B1P1p1/3p4/3NpPPn/P2b3P/8/1R1Q2K1 w - - 2 30` |
| sa-067 | 348 | d4f2 | f8g7 | 126 | None |  | `5k2/3K1p2/5p2/2p5/1p1bB3/pP1P4/P1P5/8 b - - 23 44` |
...
| sa-077 | 332 | c5b4 | h2g1 | -283 | None |  | `8/8/6k1/2Bp2P1/4bP2/4P2p/6pK/8 w - - 1 44` |
| sa-070 | 317 | a4d4 | f4f3 | 104 | None |  | `8/1p5p/p4k2/P7/R2p1K2/4p2N/2r1P1rP/4R3 w - - 4 46` |
| sa-055 | 301 | e4h4 | c3d2 | 93 | None |  | `8/8/8/3P3p/4r2P/2k1p3/6P1/1R4K1 b - - 2 70` |
...
| sa-076 | 280 | f5f3 | f5h5 | 46 | None |  | `6k1/5n1p/5P2/1ppP1R2/2p3PN/1nP1r3/2B5/6K1 w - - 1 39` |
