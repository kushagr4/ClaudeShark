...
# on their first move, so the full sort is usually never paid for. Off by
# default until measured; see benchmarks/current for the Gate 0 record.
USE_STAGED_MOVES = _flag("CS_STAGED_MOVES", False)
