...
| v2.2a-lowmaterial | v2.1 + low-material nominal-surplus scaling, `CS_EVAL_LOW_MATERIAL` (branch `v2.2-development`) | **keep for more testing; not promoted; default off.** Gate 1 passes outright (421 of 429 audited false wins removed, 0 of 112 genuine wins and 0 of 6 strategic wins damaged, +1.8% evaluator time) and in-family false-win evaluations in real games fall from 17 of 65 to 0 of 65 — but the 200-game Gate 2 has **one informative start cluster of a hundred** (99 pairs are mirror-identical), and the targeted 166-game match has 4 informative clusters of 83, of which two are genuine regressions and none are improvements. Frozen as `champions/v2_2a_low_material`. See `benchmarks/current/2026-09-04-v2.2a-low-material.md` |
