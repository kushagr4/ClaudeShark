...
from cs_drawish import low_material, low_material_reference
from cs_king import king_safety_mg, king_safety_mg_reference
from cs_kingpawn import king_pawn_packed, king_pawn_reference
...
TERMS: tuple[Term, ...] = (
    ...
    Term("king_pawn", "CS_EVAL_KING_PAWN", "packed", king_pawn_packed, king_pawn_reference),
    Term("low_material", "CS_EVAL_LOW_MATERIAL", "post", low_material, low_material_reference),
)
