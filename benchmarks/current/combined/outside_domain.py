...
res = {}
for name, path in (("C12", r"C:/Users/epick/AppData/Local/Temp/claude/C--Users-epick-Documents-ClaudeShark/e3813b42-0a37-4aea-86be-348b96190e38/scratchpad/c12"), ("RCG", LANE)):
...
print(f"positions where the gate fires (candidate): {res['RCG']['nonzero_bonus']}")
print(f"positions where the gate fires (RC-F, no term): {res['C12']['nonzero_bonus']}")
